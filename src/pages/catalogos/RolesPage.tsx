        ...
        <>
            <div className='flex flex-col flex-1 gap-6 p-6 min-h-full justify-center'>
                ...
                <div className="flex-1">
                    <p className="text-sm font-medium text-(--color-text-muted)">Roles</p>
                ...
                <SectionCard label="Datos del Rol" icon={<IconUser size={14} />}>
                    <FormInput label="Rol" icon={<IconForms size={13} />} required placeholder="Ej. Cajero" width="1/2"/>
                    <FormInput label="Descripción" icon={<IconForms size={13} />} required placeholder="Ej. Con este rol se tiene acceso limitado al sistema" width="1/2"/>
                </SectionCard>
            ...
            <BottomBar 
                    btnsLeft={<>
                        ...
                        <ActionButton label="Roles" icon={<IconTable size={14} />} variant="gWhite" />
