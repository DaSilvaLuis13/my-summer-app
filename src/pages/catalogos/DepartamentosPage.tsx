...
import { IconUser, IconForms, IconSearch, IconTable, IconArrowLeft, IconX } from "@tabler/icons-react"
        ...
        <>
            <div className='flex flex-col flex-1 gap-6 p-6 min-h-full justify-center'>
                ...
                <div className="flex-1">
                    <p className="text-sm font-medium text-(--color-text-muted)">Nombre del departamento</p>
                ...
                <SectionCard label="Datos del Departamento" icon={<IconUser size={14} />}>
                    <FormInput label="Departamento" icon={<IconForms size={13} />} required placeholder="Ej. Botanas" width="1/2"/>
                    <FormInput label="Descripción" icon={<IconForms size={13} />} required placeholder="Ej. Productos de Botanas" width="1/2"/>
                </SectionCard>
            ...
            <BottomBar 
                    btnsLeft={<>
                        ...
                        <ActionButton label="Departamentos" icon={<IconTable size={14} />} variant="gWhite" />
